...
import { customerDiscoveryRoutes } from "./routes/customer-discovery.js";
import { marketIntelligenceRoutes } from "./routes/market-intelligence.js";
import { offerDemandRoutes } from "./routes/offer-demand.js";
import { commercialValidationRoutes } from "./routes/commercial-validation.js";
import { mvpReliabilityRoutes } from "./routes/mvp-reliability.js";
import { customerValueRoutes } from "./routes/customer-value.js";
import { unitEconomicsRoutes } from "./routes/unit-economics.js";
import { businessModelCanvasRoutes } from "./routes/business-model-canvas.js";
...
export async function createApp(
  ...
  api.use(customerDiscoveryRoutes(db));
  api.use(marketIntelligenceRoutes(db));
  api.use(offerDemandRoutes(db));
  api.use(commercialValidationRoutes(db));
  api.use(mvpReliabilityRoutes(db));
  api.use(customerValueRoutes(db));
  api.use(unitEconomicsRoutes(db));
  api.use(businessModelCanvasRoutes(db));
  api.use(financialPlanningRoutes(db));
  api.use(businessPlanRoutes(db));
